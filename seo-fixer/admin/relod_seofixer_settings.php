...
<table class="sf-form-table">
    ...
    <tr>
        ...
        <td>
            <input class="sf-input" style="width:100%;max-width:560px" type="text" name="tpl_description_tail" value="<?= AdminHelper::e($tplTail); ?>" placeholder="Актуальная информация, условия и контакты на сайте.">
            <small>Фраза, которой модуль добирает длину описания. Задайте свою — она пойдёт во все предложения.</small>
        </td>
    </tr>
</table>
